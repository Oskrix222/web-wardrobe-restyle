...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "KAMIEŃ — ubezpieczenia na życie, mieszkania, turystyczne i dla firm. Porównaj oferty i zostaw kontakt. Doradca oddzwoni w ciągu 24h." },
      { name: "author", content: "KAMIEŃ" },
      { property: "og:title", content: "KAMIEŃ — Ubezpieczenia dla Ciebie i Twojej rodziny" },
      { property: "og:description", content: "Ubezpieczenia na życie, mieszkania, turystyczne i dla firm. Zostaw kontakt, a doradca przygotuje najlepszą ofertę." },
